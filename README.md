...
Скопировать `main.js`, `manifest.json` в `<волт>/.obsidian/plugins/lockstep-sync/`, включить
в настройках, вставить адрес сервера и токен.
...
MIT — весь репозиторий, и сервер, и плагин. См. [LICENSE](LICENSE).
